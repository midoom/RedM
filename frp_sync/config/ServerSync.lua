...
ss_weather_Transition = {
    ...
    ["THUNDER"] = {0xB677829F}, -- Always rotate away from Thunder, as it's annoying
...
ss_night_time_speed_mult = 1.2
ss_day_time_speed_mult = 0.9
